...
import completeIcon from "../assets/completeIcon.jpg";
...
function ProfileSetupWizard() {
      ...
      const response = await fetch('/api/profile-setup', {
        ...
        body: JSON.stringify({
          ...
          step4: {
            ...
            seekingLgbtqOnlyHomeYN: completeData.seekingLgbtqOnlyHomeYN,
  ...
  if (isComplete) {
    return (
      <div className="profileSetupContainer profileComplete">
        <img src={completeIcon} alt="pink tick in circle graphic"/>
        <h1>Profile complete!</h1>
        <p>Now you can start exploring compatible rooms or flatmates. Browse through matches, like the ones you’re interested in, and once there’s a match, you can start chatting right away.</p>
        <a href="/roomie-picks"className="greenButton">Continue to Roomie Picks</a>
      </div>
    );
  }
  ...
  return (
    <div className="profileSetupPage">
      <div className="stepHeading">
        ...
        {step === 3 && <h1>What are you<br/>looking for?</h1>}
        ...
        {step === 4 && (
          <Step4CreateListing
            ...
            defaultValues={{
              ...
              seekingLgbtqOnlyHomeYN: formData.seekingLgbtqOnlyHomeYN,
